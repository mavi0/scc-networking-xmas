import os, errno, glob, sys, smtplib, ssl, json
...
def main():
    ...
    for choice in choices:
        ...
        if not choice["Additional comment to pass to restaurant"] == "":
            content = content + "\nAdditional comment to pass to restaurant: " + choice["Additional comment to pass to restaurant"]
        else: 
        ...
        print(content)
        mail('Subject: {}\n\n{}'.format("SCC Networking Group Christmas Meal Reminder", content), choice["Email Address"])
